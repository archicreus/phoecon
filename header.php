                ...
                <div class="row justify-content-between align-items-center">
                    <div class="col-lg-2 col-md-4">
                        <div class="header-top-socials text-center text-lg-left text-md-left">
                            <a href="https://www.facebook.com/groups/522795265536482" target="_blank"><i class="ti-facebook"></i></a>
                            <a href="https://twitter.com/EDanigue" target="_blank"><i class="ti-twitter"></i></a>
                            <a href="https://github.com/archicreus/" target="_blank"><i class="ti-github"></i></a>
                        </div>
                    </div>
                    <div class="col-lg-10 col-md-8 text-center text-lg-right text-md-right">
                        <div class="header-top-info">
                            <a href="tel:+228-935-88879">Nous contacter : <span>+228 93588879</span></a>
                            <a href="mailto:edanigue6@gmail.com"><i class="fa fa-envelope mr-2"></i><span>edanigue6@gmail.com</span></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <nav class="navbar navbar-expand-lg  py-4" id="navbar">
            <div class="container">
                <a class="navbar-brand" href="index.php">
                    Phoenix <span>Consolidated.</span>
                </a>

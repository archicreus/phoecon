			...
			<div class="row">
				<div class="col-md-12">
					<div class="block text-center">
						<span class="text-white">A propos de nous</span>
						<h1 class="text-capitalize mb-4 text-lg">Notre compagnie</h1>
						<ul class="list-inline">
							<li class="list-inline-item"><a href="index.php" class="text-white">Acceuil</a></li>
							<li class="list-inline-item"><span class="text-white">/</span></li>
							<li class="list-inline-item"><a href="about.php" class="text-white-50">A propos</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-6 col-md-6">
					<div class="about-item pr-3 mb-5 mb-lg-0">
						<span class="h6 text-color">Nous sommes une solution parfaite</span>
						<h2 class="mt-3 mb-4 position-relative content-title">Nous sommes une équipe dynamique de personnes créatives</h2>
						<p class="mb-5">
							Nous fournissons des services de conseil dans le domaine des IFRS et des rapports de gestion,
			...
			<div class="row">
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="counter-item text-center mb-5 mb-lg-0">
						...
						<p class="text-white-50">Project réalisés</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="counter-item text-center mb-5 mb-lg-0">
						...
						<p class="text-white-50">De partout</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="counter-item text-center mb-5 mb-lg-0">
						...
						<p class="text-white-50">Pays disponible</p>
					</div>
				</div>
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="counter-item text-center">
						...
						<p class="text-white-50">Prix gagnés </p>
					</div>
				</div>
			</div>
		</div>

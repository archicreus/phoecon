        ...
        <div class="row ">
            <div class="col-lg-8">
                <div class="section-title">
                    <span class="h6 text-color ">Nous sommes des gens créatifs et experts</span>
                    <h2 class="mt-3 content-title">Nous travaillons avec les entreprises et fournissons une solution au client avec son problème commercial </h2>
                </div>
            </div>
        </div>
